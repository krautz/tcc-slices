...
\TRAuthor{C. Krauthamer \and E. R. M. Madeira}

% TÍTULO PARA A CAPA (use \\ para forçar quebras de linha).
\TRTitle{Um Estudo Sobre a Eficiência \\ da Alocação Dinâmica \\ de Slices em Redes 5G}
...
%
\markboth{Krauthamer e Madeira}{Alocação Dinâmica de Slices}
